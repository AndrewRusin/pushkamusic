...
let SongModule = exports.SongModule = class SongModule {
};
exports.SongModule = SongModule = __decorate([
    (0, common_1.Module)({
        controllers: [song_controller_1.SongController],
        imports: [mongoose_1.MongooseModule.forFeature([{ name: song_model_1.SongModel.name, schema: song_model_1.SongShema }])],
